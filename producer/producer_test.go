...
var _ producer.RequestMsger = (*mockRequestMsger)(nil)
...
// mockBothRequester implements both Requester and RequestMsger so priority
// between the two interfaces can be verified.
...
var (
	_ producer.Requester    = (*mockBothRequester)(nil)
	_ producer.RequestMsger = (*mockBothRequester)(nil)
)
